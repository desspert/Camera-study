...
void MaterialManager::setup(Vec3f camera_pos) {
	sphere.push_back(std::make_shared <SphereMaterial>(Vec3f(0, 0, 0), Vec3f(1, 1, 1), Vec3f(0, 0, 0), Vec3f(0, 0, 0), Vec3f(1000, 1000, 1000)
		, "skydome", "Skydome151004y.jpg"));
	cube.push_back(std::make_shared<CubeMaterial>(Vec3f(0, 0, 0), Vec3f(1, 1, 1), Vec3f(0, 0, 5), Vec3f(0, 1, 0), "jimen", "ki.png"));
